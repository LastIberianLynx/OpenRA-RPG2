...
namespace OpenRA.Mods.Common.Widgets
{
	public class WorldInteractionControllerWidget : Widget
	{
		...
		{
			//It detects button on hold only.

            TextNotificationsManager.AddTransientLine("Key:" + e.Key, World.LocalPlayer);     

			World.LastKeyUp = e;
			if(World.bPossessedActor)
			World.InputsConsumable.Add(e);
